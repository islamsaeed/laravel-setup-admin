...
<nav class="unfixednav   navbar navbar-expand-lg navbar-light ">
    <div class="container-fluid">
      ...
      <button class="navbar-toggler openallmenuenav" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
      ...
      <div class="collapse navbar-collapse main-direction-ltr" id="navbarSupportedContent">
        <ul class="navbar-nav  mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown navlanguage">
            ...
            margin-top: 10px;
            padding: 3px 10px;
            font-weight: normal !important;" class="navlanguage_A1 nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              en
            </a>
            <ul class="dropdown-menu " aria-labelledby="navbarDropdown">
